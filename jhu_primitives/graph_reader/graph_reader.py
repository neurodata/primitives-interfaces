...
class GraphReader(base.FileReaderPrimtiveBase):
    ...
    metadata = metadata_base.PrimitiveMetadata(
        {
            ...
            'id': '7a4b1b37-d3e0-4e68-af07-027ea217c3bc',
            'version': "0.1.0",
            'name': "Graph Reader",
            # The same path the primitive is registered with entry points in setup.py.
            'python_path': 'd3m.primitives.data_transformation.data_conversion.JHU',
            ...
            'source': {
                ...
                'uris': [
                    ...
                    'https://github.com/neurodata/primitives-interfaces/blob/master/jhu_primitives/graph_reader/graph_reader.py',
    ...
    def _read_fileuri(self, metadata: frozendict.FrozenOrderedDict, fileuri: str) -> container.DataFrame:
        ...
        print(expected_names, file=sys.stderr)
    ...
    #     supportedProblemTypes=['linkPrediction', 'vertexClassification', 'communityDetection', 'graphMatching']
