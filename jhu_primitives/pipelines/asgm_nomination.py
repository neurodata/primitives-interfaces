...
from jhu_primitives.asgm_nomination import AsgmNomination
...
class asgm_nomination_pipeline(BasePipeline):
    def __init__(self):
    ...
    def _gen_pipeline(self):
        ...
        step_4 = meta_pipeline.PrimitiveStep(
            primitive_description=AsgmNomination.metadata.query())
        step_4.add_argument(
            name='inputs_1',
            argument_type=ArgumentType.CONTAINER,
            data_reference='steps.1.produce'
