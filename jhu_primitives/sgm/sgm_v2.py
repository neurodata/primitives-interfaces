...
#                'https://github.com/youngser/primitives-interfaces/blob/jp-devM1/jhu_primitives/ase/ase.py',
	...
	def set_training_data(self, *, inputs: Inputs) -> None:
		...
		print(self._csv, file=sys.stderr)

		#	---------

		# print(self._csv['G1.nodeID'], file=sys.stderr)
		# print(self._csv['G1.nodeID'], file=sys.stderr)

		if isinstance(list(self._g1.nodes)[0], str):
		...
		#	---------
		G1_lookup = dict(zip(self._csv['G1.nodeID'], range(self._n_nodes)))
		self._csv['num_id1'] = self._csv['G1.nodeID'].apply(lambda x: G1_lookup[x])
		G2_lookup = dict(zip(self._csv['G2.nodeID'], range(self._n_nodes)))
		self._csv['num_id2']  = self._csv['G2.nodeID'].apply(lambda x: G2_lookup[x])
