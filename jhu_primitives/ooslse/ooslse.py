...
class OutOfSampleLaplacianSpectralEmbedding(TransformerPrimitiveBase[Inputs, Outputs, Hyperparams]):
    """
    Out of sample nodes embedded using out of sample laplacian spectral embedding.
    """
    # This should contain only metadata which cannot be automatically determined from the code.
    metadata = metadata_module.PrimitiveMetadata({
        # Simply an UUID generated once and fixed forever. Generated using "uuid.uuid4()".
        'id': '2940c526-bd9c-4899-8c84-935933236ff1',
        'version': "0.1.0",
        'name': "jhu.ooslse",
        ...
        'source': {
            ...
            'uris': [
                ...
                'https://github.com/neurodata/primitives-interfaces/jhu_primitives/ooslse/ooslse.py',
#                'https://github.com/youngser/primitives-interfaces/blob/jp-devM1/jhu_primitives/ase/ase.py',
        ...
        'description' : "Out of sample nodes embedded using out of sample laplacian spectral embedding.",
