...
#            },
    ...
    def __init__(self, *, hyperparams: Hyperparams, random_seed: int = 0, docker_containers: Dict[str, d3m.primitive_interfaces.base.DockerContainer], NoneType] = None) -> None:
